...
addRow(){let clone=this.tpl.content.cloneNode(!0);this.li.querySelector("tbody").appendChild(clone);new Item(this);this.update()}
...
toArray(){return{text:"TBD",net:this.net(),vat:this.vat(),quantity:this.quantity(),total:this.total(),}}
